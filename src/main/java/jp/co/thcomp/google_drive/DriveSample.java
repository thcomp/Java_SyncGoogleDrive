...
public class DriveSample {
	...
	private static final String UPLOAD_FILE_PATH = "C:\\Users\\H_Tatsuguchi\\Downloads\\S__4980756.jpg";
	...
	private static Credential authorize() throws Exception {
		...
		GoogleAuthorizationCodeFlow flow = new GoogleAuthorizationCodeFlow.Builder(httpTransport, JSON_FACTORY,
				clientSecrets, DriveScopes.all()).setDataStoreFactory(dataStoreFactory).build();
		// authorize
		return new AuthorizationCodeInstalledApp(flow, /* new LocalServerReceiver() */new PseudoVerificationReceiver())
				.authorize("user");
	}
